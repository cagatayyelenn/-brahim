                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                    <div class="col-xl-12 d-flex">
                        <div class="row flex-fill">
                            ...
                            <div class="col-xl-6 col-md-12 d-flex">
                                <a href="javascript:void(0);" class="card bg-danger-transparent border border-5 border-white animate-card flex-fill " data-bs-toggle="modal"
                ...
                <div class="card-header d-flex align-items-center justify-content-center flex-wrap pb-0">
                    ...
                    <div class="d-flex align-items-center flex-wrap justify-content-center">
                        <div class="input-icon-start mb-3 me-2 position-relative">
                            ...
                            <input type="text" class="form-control date-range bookingrange me-3" placeholder="Tarih Seçiniz" value="Tarih Seçiniz">
                        </div>
                        ...
                        <div class="dropdown mb-3 me-2">
                            ...
                            <ul class="dropdown-menu p-3">
                                <li><a href="javascript:void(0);" data-kasa-id="0" class="dropdown-item rounded-1   kasa-select">Bütün Kasalar</a></li>
                        ...
                        <div class="card flex-fill w-100">
                            ...
                            <div class="card-body">
                                <div class="row" id="box_nakit">
                                    <div class="col text-center border-end"><h6 class="mb-1">Giriş</h6><p class="mb-1"><span id="nakit_giris">0,00 ₺</span></p></div>
                                    <div class="col text-center border-end"><h6 class="mb-1">Çıkış</h6><p class="mb-1"><span id="nakit_cikis">0,00 ₺</span></p></div>
                                    <div class="col text-center"><h6 class="mb-1">Toplam</h6><p class="mb-1"><span id="nakit_toplam">0,00 ₺</span></p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card flex-fill w-100">
                            ...
                            <div class="card-body">
                                <div class="border rounded p-3" id="box_pos">
                                    <div class="row">
                                        <div class="col text-center border-end"><h6 class="mb-1">Giriş</h6><p class="mb-1"><span id="pos_giris">0,00 ₺</span></p></div>
                                        <div class="col text-center border-end"><h6 class="mb-1">Çıkış</h6><p class="mb-1"><span id="pos_cikis">0,00 ₺</span></p></div>
                                        <div class="col text-center"><h6 class="mb-1">Toplam</h6><p class="mb-1"><span id="pos_toplam">0,00 ₺</span></p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card flex-fill w-100">
                            ...
                            <div class="card-body">
                                <div class="border rounded p-3" id="box_banka">
                                    <div class="row">
                                        <div class="col text-center border-end"><h6 class="mb-1">Giriş</h6><p class="mb-1"><span id="banka_giris">0,00 ₺</span></p></div>
                                        <div class="col text-center border-end"><h6 class="mb-1">Çıkış</h6><p class="mb-1"><span id="banka_cikis">0,00 ₺</span></p></div>
                                        <div class="col text-center"><h6 class="mb-1">Toplam</h6><p class="mb-1"><span id="banka_toplam">0,00 ₺</span></p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card flex-fill w-100">
                            ...
                            <div class="card-body">
                                <div class="border rounded p-3" id="box_toplam">
                                    <div class="row">
                                        <div class="col text-center border-end"><h6 class="mb-1">Giriş</h6><p class="mb-1"><span id="toplam_giris">0,00 ₺</span></p></div>
                                        <div class="col text-center border-end"><h6 class="mb-1">Çıkış</h6><p class="mb-1"><span id="toplam_cikis">0,00 ₺</span></p></div>
                                        <div class="col text-center"><h6 class="mb-1">Toplam</h6><p class="mb-1"><span id="toplam_toplam">0,00 ₺</span></p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body p-0 py-3">
                    <div class="custom-datatable-filter table-responsive">
                        <table class="table datatable align-middle mb-0" id="kasaTable">
                            ...
                            <tr>
                                <th>ID</th><th>Tarih</th><th>Kasa</th><th>Bağlantı</th><th>Kategori</th>
                                <th>Ödeme Türü</th><th>Açıklama</th><th>İşlemi Yapan</th><th>Yön</th>
                                <th class="text-end">Tutar</th><th>İşlem</th>
                            </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
