...
<head>
	...
	<!-- Theme Script js -->
	<script src="assets/js/theme-script.js" type="565524760b109b69ccc5ade5-text/javascript"></script>
...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<a id="mobile_btn" class="mobile_btn" href="permission.html#sidebar">
				<span class="bar-icon">
					<span></span>
					<span></span>
					<span></span>
				...
				<div class="nav user-menu">
					...
					<div class="d-flex align-items-center">
						<div class="dropdown me-2">
							<a href="permission.html#" class="btn btn-outline-light fw-normal bg-white d-flex align-items-center p-2"
						...
						<div class="pe-1">
							<div class="dropdown">
								<a href="permission.html#" class="btn btn-outline-light bg-white btn-icon me-1"
									data-bs-toggle="dropdown" aria-expanded="false">
						...
						<div class="pe-1">
							<a href="permission.html#" id="dark-mode-toggle"
								class="dark-mode-toggle activate btn btn-outline-light bg-white btn-icon me-1">
								<i class="ti ti-moon"></i>
							</a>
							<a href="permission.html#" id="light-mode-toggle"
						...
						<div class="pe-1" id="notification_item">
							<a href="permission.html#" class="btn btn-outline-light bg-white btn-icon position-relative me-1"
							...
							<div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
								<div
									...
									<div class="d-flex align-items-center">
										<a href="permission.html#" class="text-primary fs-15 me-3 lh-1">Mark all as read</a>
										<div class="dropdown">
								...
								<div class="d-flex p-0">
									<a href="permission.html#" class="btn btn-light w-100 me-2">Cancel</a>
						...
						<div class="pe-1">
							<a href="permission.html#" class="btn btn-outline-light bg-white btn-icon me-1" id="btnFullscreen">
			...
			<div class="content">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between mb-3">
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
						<div class="pe-1 mb-2">
							<a href="permission.html#" class="btn btn-outline-light bg-white btn-icon me-1" data-bs-toggle="tooltip"
						...
						<div class="mb-2">
							<a href="permission.html#" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal"
				...
				<div class="modal-content">
					...
					<form action="roles-permission.html">
						...
						<div class="modal-footer">
							<a href="permission.html#" class="btn btn-light me-2" data-bs-dismiss="modal">Cancel</a>
	...
	<!-- jQuery -->
	<script src="assets/js/jquery-3.7.1.min.js" type="565524760b109b69ccc5ade5-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="assets/js/bootstrap.bundle.min.js" type="565524760b109b69ccc5ade5-text/javascript"></script>

	<!-- Daterangepikcer JS -->
	<script src="assets/js/moment.js" type="565524760b109b69ccc5ade5-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="565524760b109b69ccc5ade5-text/javascript"></script>

	<!-- Feather Icon JS -->
	<script src="assets/js/feather.min.js" type="565524760b109b69ccc5ade5-text/javascript"></script>

	<!-- Slimscroll JS -->
	<script src="assets/js/jquery.slimscroll.min.js" type="565524760b109b69ccc5ade5-text/javascript"></script>

	<!-- Datatable JS -->
	<script src="assets/js/jquery.dataTables.min.js" type="565524760b109b69ccc5ade5-text/javascript"></script>
	<script src="assets/js/dataTables.bootstrap5.min.js" type="565524760b109b69ccc5ade5-text/javascript"></script>

	<!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="565524760b109b69ccc5ade5-text/javascript"></script>

	<!-- Datetimepicker JS -->
	<script src="assets/js/bootstrap-datetimepicker.min.js" type="565524760b109b69ccc5ade5-text/javascript"></script>

	<!-- Custom JS -->
	<script src="assets/js/script.js" type="565524760b109b69ccc5ade5-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="565524760b109b69ccc5ade5-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"3ca157e612a14eccbb30cf6db6691c29","server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>
