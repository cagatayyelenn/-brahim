...
<head>
	...
	<!-- Theme Script js -->
	<script src="assets/js/theme-script.js" type="94405125ce0c4a6373878a05-text/javascript"></script>
...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<a id="mobile_btn" class="mobile_btn" href="security-settings.html#sidebar">
				<span class="bar-icon">
					<span></span>
					<span></span>
					<span></span>
				...
				<div class="nav user-menu">
					...
					<div class="d-flex align-items-center">
						<div class="dropdown me-2">
							<a href="security-settings.html#" class="btn btn-outline-light fw-normal bg-white d-flex align-items-center p-2"
						...
						<div class="pe-1">
							<div class="dropdown">
								<a href="security-settings.html#" class="btn btn-outline-light bg-white btn-icon me-1"
									data-bs-toggle="dropdown" aria-expanded="false">
						...
						<div class="pe-1">
							<a href="security-settings.html#" id="dark-mode-toggle"
								class="dark-mode-toggle activate btn btn-outline-light bg-white btn-icon me-1">
								<i class="ti ti-moon"></i>
							</a>
							<a href="security-settings.html#" id="light-mode-toggle"
						...
						<div class="pe-1" id="notification_item">
							<a href="security-settings.html#" class="btn btn-outline-light bg-white btn-icon position-relative me-1"
							...
							<div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
								<div
									...
									<div class="d-flex align-items-center">
										<a href="security-settings.html#" class="text-primary fs-15 me-3 lh-1">Mark all as read</a>
										<div class="dropdown">
								...
								<div class="d-flex p-0">
									<a href="security-settings.html#" class="btn btn-light w-100 me-2">Cancel</a>
						...
						<div class="pe-1">
							<a href="security-settings.html#" class="btn btn-outline-light bg-white btn-icon me-1" id="btnFullscreen">
							...
							<ul>
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="security-settings.html" class="active">Security Settings</a></li>
			...
			<div class="content">
				<div class="d-md-flex d-block align-items-center justify-content-between border-bottom pb-3">
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
						<div class="pe-1 mb-2">
							<a href="security-settings.html#" class="btn btn-outline-light bg-white btn-icon" data-bs-toggle="tooltip"
				...
				<div class="row">
					<div class="col-xxl-2 col-xl-3">
						<div class="pt-3 d-flex flex-column list-group mb-4">
							<a href="profile-settings.html" class="d-block rounded p-2">Profile Settings</a>
							<a href="security-settings.html" class="d-block rounded active p-2">Security Settings</a>
							<a href="notifications-settings.html" class="d-block rounded p-2">Notifications</a>
							<a href="connected-apps.html" class="d-block rounded p-2">Connected Apps</a>
						</div>
					</div>
					<div class="col-xxl-10 col-xl-9">
						<div class="border-start ps-3 flex-fill">
							<div
								class="d-flex align-items-center justify-content-between flex-wrap border-bottom mb-3 pt-3">
								<div class="mb-3">
							...
							<div class="d-block">
								<div
									class="d-flex justify-content-between align-items-center rounded flex-wrap bg-white border rounded p-3 pb-0 mb-3">
									<div class="mb-3">
										<h6>Password</h6>
										<p>Set a unique password to protect the account</p>
									</div>
									<div class="mb-3">
										<a href="security-settings.html#" class="btn btn-outline-primary">Change Pasword</a>
									</div>
								</div>
								<div
									class="d-flex justify-content-between align-items-center rounded flex-wrap bg-white border rounded p-3 pb-0 mb-3">
								...
								<div
									...
									<div class="d-flex align-items-center mb-3">
										<span class="badge badge-soft-success me-3"><i
												class="ti ti-circle-filled fs-5 me-1"></i>Connected</span>
										<div class="form-check form-switch">
											<input class="form-check-input" type="checkbox" role="switch"
												id="switch-sm2">
										</div>
								...
								<div
									...
									<div class="d-flex align-items-center flex-wrap">
										<p class="mb-3 me-3">+1 73649 72648</p>
										<span class="badge badge-soft-success me-3 mb-3"><i
												class="ti ti-checks me-1"></i>Verified</span>
										<a href="security-settings.html#" class="btn btn-light mb-3"><i class="ti ti-edit me-2"></i>Edit</a>
									</div>
								</div>
								<div
									class="d-flex justify-content-between align-items-center rounded flex-wrap bg-white border rounded p-3 pb-0 mb-3">
									...
									<div class="d-flex align-items-center flex-wrap">
										<p class="mb-3 me-3"><a href="https://preskool.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="94f5f0f9fdfad4f1ecf5f9e4f8f1baf7fbf9">[email&#160;protected]</a></p>
										<span class="badge badge-soft-success me-3 mb-3"><i
												class="ti ti-checks me-1"></i>Verified</span>
										<a href="security-settings.html#" class="btn btn-light mb-3"><i class="ti ti-edit me-2"></i>Edit</a>
									</div>
								...
								<div
									...
									<div class="mb-3">
										<a href="security-settings.html#" class="btn btn-outline-primary">Manage</a>
									</div>
								</div>
								<div
									class="d-flex justify-content-between align-items-center rounded flex-wrap bg-white border rounded p-3 pb-0 mb-3">
									...
									<div class="mb-3">
										<a href="security-settings.html#" class="btn btn-outline-primary">View</a>
									</div>
								</div>
								<div
									class="d-flex justify-content-between align-items-center rounded flex-wrap bg-white border rounded p-3 pb-0 mb-3">
									<div class="mb-3">
										...
										<p>This will shutdown your account. Your account will be reactive when you sign
											in again </p>
									</div>
									<div class="mb-3">
										<a href="security-settings.html#" class="btn btn-outline-primary">Deactivate</a>
									</div>
								</div>
								<div
									class="d-flex justify-content-between align-items-center rounded flex-wrap bg-white border rounded p-3 pb-0 mb-3">
									...
									<div class="mb-3">
										<a href="security-settings.html#" class="btn btn-outline-danger" data-bs-toggle="modal"
	...
	<!-- jQuery -->
	<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-3.7.1.min.js" type="94405125ce0c4a6373878a05-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="assets/js/bootstrap.bundle.min.js" type="94405125ce0c4a6373878a05-text/javascript"></script>

	<!-- Daterangepikcer JS -->
	<script src="assets/js/moment.js" type="94405125ce0c4a6373878a05-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="94405125ce0c4a6373878a05-text/javascript"></script>

	<!-- Datetimepicker JS -->
	<script src="assets/plugins/moment/moment.js" type="94405125ce0c4a6373878a05-text/javascript"></script>
	<script src="assets/js/bootstrap-datetimepicker.min.js" type="94405125ce0c4a6373878a05-text/javascript"></script>

	<!-- Feather Icon JS -->
	<script src="assets/js/feather.min.js" type="94405125ce0c4a6373878a05-text/javascript"></script>

	<!-- Slimscroll JS -->
	<script src="assets/js/jquery.slimscroll.min.js" type="94405125ce0c4a6373878a05-text/javascript"></script>

	<!-- Datatable JS -->
	<script src="assets/js/jquery.dataTables.min.js" type="94405125ce0c4a6373878a05-text/javascript"></script>
	<script src="assets/js/dataTables.bootstrap5.min.js" type="94405125ce0c4a6373878a05-text/javascript"></script>

	<!-- Custom JS -->
	<script src="assets/js/script.js" type="94405125ce0c4a6373878a05-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="94405125ce0c4a6373878a05-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"3ca157e612a14eccbb30cf6db6691c29","server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>
