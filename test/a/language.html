...
<head>
	...
	<!-- Theme Script js -->
	<script src="assets/js/theme-script.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>
...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<a id="mobile_btn" class="mobile_btn" href="language.html#sidebar">
				<span class="bar-icon">
					<span></span>
					<span></span>
					<span></span>
				...
				<div class="nav user-menu">
					...
					<div class="d-flex align-items-center">
						<div class="dropdown me-2">
							<a href="language.html#" class="btn btn-outline-light fw-normal bg-white d-flex align-items-center p-2"
						...
						<div class="pe-1">
							<div class="dropdown">
								<a href="language.html#" class="btn btn-outline-light bg-white btn-icon me-1"
									data-bs-toggle="dropdown" aria-expanded="false">
						...
						<div class="pe-1">
							<a href="language.html#" id="dark-mode-toggle"
								class="dark-mode-toggle activate btn btn-outline-light bg-white btn-icon me-1">
								<i class="ti ti-moon"></i>
							</a>
							<a href="language.html#" id="light-mode-toggle"
						...
						<div class="pe-1" id="notification_item">
							<a href="language.html#" class="btn btn-outline-light bg-white btn-icon position-relative me-1"
							...
							<div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
								<div
									...
									<div class="d-flex align-items-center">
										<a href="language.html#" class="text-primary fs-15 me-3 lh-1">Mark all as read</a>
										<div class="dropdown">
								...
								<div class="d-flex p-0">
									<a href="language.html#" class="btn btn-light w-100 me-2">Cancel</a>
						...
						<div class="pe-1">
							<a href="language.html#" class="btn btn-outline-light bg-white btn-icon me-1" id="btnFullscreen">
			...
			<div class="content bg-white">
				<div class="d-md-flex d-block align-items-center justify-content-between border-bottom pb-3">
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
						<div class="pe-1 mb-2">
							<a href="language.html#" class="btn btn-outline-light bg-white btn-icon" data-bs-toggle="tooltip"
				...
				<div class="row">
					<div class="col-xxl-2 col-xl-3">
						<div class="pt-3 d-flex flex-column list-group mb-4">
							<a href="company-settings.html" class="d-block rounded p-2">Company Settings</a>
							...
							<a href="language.html" class="d-block rounded p-2 active">Language</a>
						</div>
					</div>
					<div class="col-xxl-10 col-xl-9">
						<div class="border-start ps-3">
							<div
								...
								<div class="mb-3">
									<a href="language.html#" class="btn btn-light me-2" data-bs-toggle="modal"
										data-bs-target="#import_file"><i class="ti ti-download me-2"></i>Import</a>
									<a href="language.html#" class="btn btn-primary" data-bs-toggle="modal"
											...
											<div class="dropdown-menu drop-width">
												<form action="language.html">
													...
													<div class="p-3 d-flex align-items-center justify-content-end">
														<a href="language.html#" class="btn btn-light me-2">Reset</a>
										...
										<div class="dropdown mb-3">
											<a href="javascript:void(0);"
												...
												data-bs-toggle="dropdown"><i
													class="ti ti-sort-ascending-2 me-2"></i>Sort by A-Z
											</a>
													...
													<td>
														<div class="dropdown">
															...
															<ul class="dropdown-menu dropdown-menu-right p-3">
																<li>
																	<a class="dropdown-item rounded-1" href="language.html#"><i
																			class="ti ti-language me-2"></i>Make as
																		Default</a>
																</li>
																<li>
																	<a class="dropdown-item rounded-1" href="language.html#"
																		data-bs-toggle="modal"
																		data-bs-target="#edit_language"><i
																			class="ti ti-edit-circle me-2"></i>Edit</a>
																</li>
																<li>
																	<a class="dropdown-item rounded-1" href="language.html#"
																		data-bs-toggle="modal"
																		data-bs-target="#language_setup"><i
																			class="ti ti-settings me-2"></i>Set up</a>
																</li>
																<li>
																	<a class="dropdown-item rounded-1" href="language.html#"
																		data-bs-toggle="modal"
				...
				<div class="modal-content">
					...
					<form action="language.html">
						...
						<div class="modal-footer">
							<a href="language.html#" class="btn btn-light me-2" data-bs-dismiss="modal">Cancel</a>
								...
								<div class="dropdown mb-3 me-2">
									...
									<div class="dropdown-menu drop-width">
										<form action="language.html">
											...
											<div class="p-3 d-flex align-items-center justify-content-end">
												<a href="language.html#" class="btn btn-light me-3">Reset</a>
												<button type="submit" class="btn btn-primary">Apply</button>
											</div>
										</form>
									</div>
	...
	<!-- jQuery -->
	<script src="assets/js/jquery-3.7.1.min.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="assets/js/bootstrap.bundle.min.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>

	<!-- Daterangepikcer JS -->
	<script src="assets/js/moment.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>

	<!-- Datetimepicker JS -->
	<script src="assets/plugins/moment/moment.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>
	<script src="assets/js/bootstrap-datetimepicker.min.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>

	<!-- Feather Icon JS -->
	<script src="assets/js/feather.min.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>

	<!-- Select2 JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>

	<!-- Slimscroll JS -->
	<script src="assets/js/jquery.slimscroll.min.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>

	<!-- Datatable JS -->
	<script src="assets/js/jquery.dataTables.min.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>
	<script src="assets/js/dataTables.bootstrap5.min.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>

	<!-- Custom JS -->
	<script src="assets/js/script.js" type="9f439b91b0f42718ad06b968-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="9f439b91b0f42718ad06b968-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"3ca157e612a14eccbb30cf6db6691c29","server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>
