...
<head>
	...
	<!-- Theme Script js -->
	<script src="assets/js/theme-script.js" type="332d042b85f250aca289c2d1-text/javascript"></script>
...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<a id="mobile_btn" class="mobile_btn" href="notifications-settings.html#sidebar">
				<span class="bar-icon">
					<span></span>
					<span></span>
					<span></span>
				...
				<div class="nav user-menu">
					...
					<div class="d-flex align-items-center">
						<div class="dropdown me-2">
							<a href="notifications-settings.html#" class="btn btn-outline-light fw-normal bg-white d-flex align-items-center p-2"
						...
						<div class="pe-1">
							<div class="dropdown">
								<a href="notifications-settings.html#" class="btn btn-outline-light bg-white btn-icon me-1"
									data-bs-toggle="dropdown" aria-expanded="false">
						...
						<div class="pe-1">
							<a href="notifications-settings.html#" id="dark-mode-toggle"
								class="dark-mode-toggle activate btn btn-outline-light bg-white btn-icon me-1">
								<i class="ti ti-moon"></i>
							</a>
							<a href="notifications-settings.html#" id="light-mode-toggle"
						...
						<div class="pe-1" id="notification_item">
							<a href="notifications-settings.html#" class="btn btn-outline-light bg-white btn-icon position-relative me-1"
							...
							<div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
								<div
									...
									<div class="d-flex align-items-center">
										<a href="notifications-settings.html#" class="text-primary fs-15 me-3 lh-1">Mark all as read</a>
										<div class="dropdown">
								...
								<div class="d-flex p-0">
									<a href="notifications-settings.html#" class="btn btn-light w-100 me-2">Cancel</a>
						...
						<div class="pe-1">
							<a href="notifications-settings.html#" class="btn btn-outline-light bg-white btn-icon me-1" id="btnFullscreen">
							...
							<ul>
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="notifications-settings.html" class="active">Notifications
												Settings</a></li>
			...
			<div class="content">
				<div class="d-md-flex d-block align-items-center justify-content-between border-bottom pb-3">
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
						<div class="pe-1 mb-2">
							<a href="notifications-settings.html#" class="btn btn-outline-light bg-white btn-icon" data-bs-toggle="tooltip"
				...
				<div class="row">
					<div class="col-xxl-2 col-xl-3">
						<div class="pt-3 d-flex flex-column list-group mb-4">
							...
							<a href="security-settings.html" class="d-block rounded p-2">Security Settings</a>
							<a href="notifications-settings.html" class="d-block rounded active p-2">Notifications</a>
							...
							<div class="d-block">
								<div class="card border-0 p-3 pb-0 mb-3 rounded">
									<div
										...
										<div class="mb-3">
											...
											<p>Substance can send you email notifications for any new direct messages
											</p>
										</div>
										<div class="mb-3">
								...
								<div class="card border-0 p-3 pb-0 mb-3 rounded">
									...
									<div
										...
										<div class="mb-3">
											<h6>Activity Only</h6>
											<p>Ony notify latest activity updates about increasing or decreasing data
											</p>
										</div>
										<div class="mb-3">
											<div class="form-check form-check-md">
	...
	<!-- jQuery -->
	<script src="assets/js/jquery-3.7.1.min.js" type="332d042b85f250aca289c2d1-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="assets/js/bootstrap.bundle.min.js" type="332d042b85f250aca289c2d1-text/javascript"></script>

	<!-- Daterangepikcer JS -->
	<script src="assets/js/moment.js" type="332d042b85f250aca289c2d1-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="332d042b85f250aca289c2d1-text/javascript"></script>

	<!-- Datetimepicker JS -->
	<script src="assets/plugins/moment/moment.js" type="332d042b85f250aca289c2d1-text/javascript"></script>
	<script src="assets/js/bootstrap-datetimepicker.min.js" type="332d042b85f250aca289c2d1-text/javascript"></script>

	<!-- Feather Icon JS -->
	<script src="assets/js/feather.min.js" type="332d042b85f250aca289c2d1-text/javascript"></script>

	<!-- Slimscroll JS -->
	<script src="assets/js/jquery.slimscroll.min.js" type="332d042b85f250aca289c2d1-text/javascript"></script>

	<!-- Datatable JS -->
	<script src="assets/js/jquery.dataTables.min.js" type="332d042b85f250aca289c2d1-text/javascript"></script>
	<script src="assets/js/dataTables.bootstrap5.min.js" type="332d042b85f250aca289c2d1-text/javascript"></script>

	<!-- Custom JS -->
	<script src="assets/js/script.js" type="332d042b85f250aca289c2d1-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="332d042b85f250aca289c2d1-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"3ca157e612a14eccbb30cf6db6691c29","server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>
