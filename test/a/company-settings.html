...
<head>
	...
	<!-- Theme Script -->
	<script src="assets/js/theme-script.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>
...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<a id="mobile_btn" class="mobile_btn" href="company-settings.html#sidebar">
				<span class="bar-icon">
					<span></span>
					<span></span>
					<span></span>
				...
				<div class="nav user-menu">
					...
					<div class="d-flex align-items-center">
						<div class="dropdown me-2">
							<a href="company-settings.html#" class="btn btn-outline-light fw-normal bg-white d-flex align-items-center p-2"  data-bs-toggle="dropdown" aria-expanded="false">
						...
						<div class="pe-1 ms-1">
							<div class="dropdown">
								<a href="company-settings.html#" class="btn btn-outline-light bg-white btn-icon d-flex align-items-center me-1 p-2"  data-bs-toggle="dropdown" aria-expanded="false">
						...
						<div class="pe-1">
							<div class="dropdown">
								<a href="company-settings.html#" class="btn btn-outline-light bg-white btn-icon me-1"  data-bs-toggle="dropdown" aria-expanded="false">
						...
						<div class="pe-1">
							<a href="company-settings.html#" id="dark-mode-toggle" class="dark-mode-toggle activate btn btn-outline-light bg-white btn-icon me-1">
								<i class="ti ti-moon"></i>
							</a>
							<a href="company-settings.html#" id="light-mode-toggle" class="dark-mode-toggle btn btn-outline-light bg-white btn-icon me-1">
								<i class="ti ti-brightness-up"></i>
							</a>
						</div>
						<div class="pe-1" id="notification_item">
							<a href="company-settings.html#" class="btn btn-outline-light bg-white btn-icon position-relative me-1" id="notification_popup">
							...
							<div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
								<div class="d-flex align-items-center justify-content-between border-bottom p-0 pb-3 mb-3">
									...
									<div class="d-flex align-items-center">
										<a href="company-settings.html#" class="text-primary fs-15 me-3 lh-1">Mark all as read</a>
										<div class="dropdown">
								...
								<div class="d-flex p-0">
									<a href="company-settings.html#" class="btn btn-light w-100 me-2">Cancel</a>
						...
						<div class="pe-1">
							<a href="company-settings.html#" class="btn btn-outline-light bg-white btn-icon me-1">
								<i class="ti ti-chart-bar"></i>
							</a>
						</div>
						<div class="pe-1">
							<a href="company-settings.html#" class="btn btn-outline-light bg-white btn-icon me-1" id="btnFullscreen">
						...
						<li>
							...
							<ul>
								...
								<li class="submenu">
									...
									<ul>
										<li><a href="company-settings.html" class="active">Company Settings</a></li>
			...
			<div class="content">
				<div class="d-md-flex d-block align-items-center justify-content-between border-bottom pb-3">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                      	<div class="pe-1 mb-2">
                       		<a href="company-settings.html#" class="btn btn-outline-light bg-white btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Refresh" data-bs-original-title="Refresh">
				...
				<div class="row">
					<div class="col-xxl-2 col-xl-3">
						<div class="pt-3 d-flex flex-column list-group mb-4">
							<a href="company-settings.html" class="d-block rounded p-2 active">Company Settings</a>
							<a href="localization.html" class="d-block rounded p-2">Localization</a>
							<a href="prefixes.html" class="d-block rounded p-2">Prefixes</a>
							<a href="preferences.html" class="d-block rounded p-2">Preferences</a>
							<a href="social-authentication.html" class="d-block rounded p-2">Social Authentication</a>
							<a href="language.html" class="d-block rounded p-2">Language</a>
						</div>
					</div>
	...
	<!-- jQuery -->
	<script src="assets/js/jquery-3.7.1.min.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="assets/js/bootstrap.bundle.min.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>

	<!-- Daterangepikcer JS -->
	<script src="assets/js/moment.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>

	<!-- Datetimepicker JS -->
	<script src="assets/plugins/moment/moment.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>
	<script src="assets/js/bootstrap-datetimepicker.min.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>

	<!-- Feather Icon JS -->
	<script src="assets/js/feather.min.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>

	<!-- Slimscroll JS -->
	<script src="assets/js/jquery.slimscroll.min.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>

	<!-- Datatable JS -->
	<script src="assets/js/jquery.dataTables.min.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>
	<script src="assets/js/dataTables.bootstrap5.min.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>

	<!-- Custom JS -->
	<script src="assets/js/script.js" type="ef2c6ee510325a0872e95873-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="ef2c6ee510325a0872e95873-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"3ca157e612a14eccbb30cf6db6691c29","server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>
