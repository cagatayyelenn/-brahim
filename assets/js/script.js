...
$(document).ready(function(){
	...
	if ($('.datatable').length > 0) {
		$('.datatable').each(function () {
			// Aynı tabloya ikinci kez DataTable kurulmasın
			if (!$.fn.DataTable.isDataTable(this)) {
				$(this).DataTable({
					bFilter: true,
					ordering: true,
					info: true, // bilgi satırını istiyorsan true kalsın
					language: {
						url: 'https://cdn.datatables.net/plug-ins/1.13.6/i18n/tr.json', // Türkçe dil dosyası
						search: ' ',
...
// Türkçe locale ayarı (moment yüklendikten sonra)
moment.locale('tr');
