...
<head>
    ...
    <!-- Theme Script -->
    <script src="assets/js/theme-script.js" type="90350b53c49d15e47d297da5-text/javascript"></script>
...
<div class="main-wrapper">
    ...
    <div class="header">
        ...
        <a id="mobile_btn" class="mobile_btn" href="designation.html#sidebar">
				<span class="bar-icon">
					<span></span>
					<span></span>
					<span></span>
            ...
            <div class="nav user-menu">
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown me-2">
                        <a href="designation.html#" class="btn btn-outline-light fw-normal bg-white d-flex align-items-center p-2"  data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="pe-1 ms-1">
                        <div class="dropdown">
                            <a href="designation.html#" class="btn btn-outline-light bg-white btn-icon d-flex align-items-center me-1 p-2"  data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="pe-1">
                        <div class="dropdown">
                            <a href="designation.html#" class="btn btn-outline-light bg-white btn-icon me-1"  data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="pe-1">
                        <a href="designation.html#" id="dark-mode-toggle" class="dark-mode-toggle activate btn btn-outline-light bg-white btn-icon me-1">
                            <i class="ti ti-moon"></i>
                        </a>
                        <a href="designation.html#" id="light-mode-toggle" class="dark-mode-toggle btn btn-outline-light bg-white btn-icon me-1">
                            <i class="ti ti-brightness-up"></i>
                        </a>
                    </div>
                    <div class="pe-1" id="notification_item">
                        <a href="designation.html#" class="btn btn-outline-light bg-white btn-icon position-relative me-1" id="notification_popup">
                        ...
                        <div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
                            <div class="d-flex align-items-center justify-content-between border-bottom p-0 pb-3 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="designation.html#" class="text-primary fs-15 me-3 lh-1">Mark all as read</a>
                                    <div class="dropdown">
                            ...
                            <div class="d-flex p-0">
                                <a href="designation.html#" class="btn btn-light w-100 me-2">Cancel</a>
                    ...
                    <div class="pe-1">
                        <a href="designation.html#" class="btn btn-outline-light bg-white btn-icon me-1">
                            <i class="ti ti-chart-bar"></i>
                        </a>
                    </div>
                    <div class="pe-1">
                        <a href="designation.html#" class="btn btn-outline-light bg-white btn-icon me-1" id="btnFullscreen">
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="layout-default.html"><i class="ti ti-layout-sidebar"></i><span>Default </span></a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="players.html"><i class="ti ti-play-football"></i><span>Players</span></a></li>
                            <li class="submenu">
                                <a href="javascript:void(0);"><i
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="designation.html"><i
        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                    <div class="pe-1 mb-2">
                        <a href="designation.html#" class="btn btn-outline-light bg-white btn-icon me-1" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Refresh" data-bs-original-title="Refresh">
                    ...
                    <div class="mb-2">
                        ...
                        <a href="designation.html#" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal"
                            ...
                            <div class="dropdown-menu drop-width">
                                <form action="designation.html">
                                    ...
                                    <div class="p-3 d-flex align-items-center justify-content-end">
                                        <a href="designation.html#" class="btn btn-light me-3">Reset</a>
                    ...
                    <div class="custom-datatable-filter table-responsive">
                        <table class="table datatable">
                            ...
                            <tr>
                                ...
                                <td><a href="designation.html#" class="link-primary">DS748294</a></td>
                                <td>
                                    Technical Head
                                </td>
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right p-3">
                                                ...
                                                <li>
                                                    <a class="dropdown-item rounded-1" href="designation.html#"
                            ...
                            <tr>
                                ...
                                <td><a href="designation.html#" class="link-primary">DS748293</a></td>
                                <td>
                                    Accountant
                                </td>
                            ...
                            <tr>
                                ...
                                <td><a href="designation.html#" class="link-primary">DS748292</a></td>
                                <td>
                                    Teacher
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><a href="designation.html#" class="link-primary">DS748291</a></td>
                                <td>
                                    Librarian
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><a href="designation.html#" class="link-primary">DS748290</a></td>
                                <td>
                                    Doctor
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><a href="designation.html#" class="link-primary">DS748289</a></td>
                                <td>
                                    Driver
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><a href="designation.html#" class="link-primary">DS748288</a></td>
                                <td>
                                    Warden
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><a href="designation.html#" class="link-primary">DS748287</a></td>
                                <td>
                                    Receptionist
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><a href="designation.html#" class="link-primary">DS748286</a></td>
                                <td>
                                    Therapist
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><a href="designation.html#" class="link-primary">DS748285</a></td>
                                <td>
                                    Coach
                                </td>
                                <td>
            ...
            <div class="modal-content">
                ...
                <form action="designation.html">
                    ...
                    <div class="modal-footer">
                        <a href="designation.html#" class="btn btn-light me-2" data-bs-dismiss="modal">Cancel</a>
...
<!-- jQuery -->
<script src="assets/js/jquery-3.7.1.min.js" type="90350b53c49d15e47d297da5-text/javascript"></script>

<!-- Bootstrap Core JS -->
<script src="assets/js/bootstrap.bundle.min.js" type="90350b53c49d15e47d297da5-text/javascript"></script>

<!-- Daterangepikcer JS -->
<script src="assets/js/moment.js" type="90350b53c49d15e47d297da5-text/javascript"></script>
<script src="assets/plugins/daterangepicker/daterangepicker.js" type="90350b53c49d15e47d297da5-text/javascript"></script>

<!-- Feather Icon JS -->
<script src="assets/js/feather.min.js" type="90350b53c49d15e47d297da5-text/javascript"></script>

<!-- Slimscroll JS -->
<script src="assets/js/jquery.slimscroll.min.js" type="90350b53c49d15e47d297da5-text/javascript"></script>

<!-- Datatable JS -->
<script src="assets/js/jquery.dataTables.min.js" type="90350b53c49d15e47d297da5-text/javascript"></script>
<script src="assets/js/dataTables.bootstrap5.min.js" type="90350b53c49d15e47d297da5-text/javascript"></script>

<!-- Select2 JS -->
<script src="assets/plugins/select2/js/select2.min.js" type="90350b53c49d15e47d297da5-text/javascript"></script>

<!-- Datetimepicker JS -->
<script src="assets/js/bootstrap-datetimepicker.min.js" type="90350b53c49d15e47d297da5-text/javascript"></script>

<!-- Custom JS -->
<script src="assets/js/script.js" type="90350b53c49d15e47d297da5-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="90350b53c49d15e47d297da5-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"3ca157e612a14eccbb30cf6db6691c29","server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>
