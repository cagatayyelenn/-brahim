            ...
            <div class="col-md-12">
                <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center  flex-wrap">
                        <a href="student-details.html#" class="btn btn-light me-2 mb-2" data-bs-toggle="modal"
                            data-bs-target="#login_detail"><i class="ti ti-lock me-2"></i>Panel Giriş Bilgileri</a>
                        <a href="ogrenci-duzenle.php?id=<?= $ogrenci['ogrenci_numara'] ?>"
                            class="btn btn-primary d-flex align-items-center mb-2"><i
                                class="ti ti-edit-circle me-2"></i>Öğrenciyi Düzenle</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
