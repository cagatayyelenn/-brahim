...
LEFT JOIN (
    SELECT 
        ...
        SUM(toplam_tutar) AS total_odeme 
    FROM kurs_satislari 
    GROUP BY ogrenci_id
...
WHERE o.sube_id = {$_SESSION['subedurum']}
ORDER BY o.ogrenci_id DESC";
$rows = $Ydil->get($sql);
                        ...
                        <table id="datatablesSimple">
                            ...
                            <?php foreach ($rows as $r): ?>
                                ...
                                <tr >
                                    ...
                                    <td><?= (int)$r['kurs_sayisi'] ?> / <?= (int)$r['toplam_taksit'] ?></td>
