...
<head>
    ...
    <meta name="author" content="Sqooler eğitim sistemi">
            ...
            <div class="col-md-5 mx-auto">
                    <div class="d-flex flex-column justify-content-between vh-100">
                        <div class=" mx-auto p-4 text-center">
                            <img src="https://bluebellenglishacademy.com/wp-content/uploads/2025/05/1.png" class="img-fluid" alt="Logo">
                        </div>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="text-center">
                                        <h6 class="fw-normal text-dark mb-0">
                                            Şifrenizi unuttuysanız <span class="fw-normal text-success mb-0">Sqooler eğitim sistemi</span> ile iletişime geçin
                                        </h6>
                                    </div>
                                </div>
                            </div>
