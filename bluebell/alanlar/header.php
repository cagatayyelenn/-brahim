...
<head>
    ...
    <style>
        .icon-addon{position:absolute;left:.75rem;top:50%;transform:translateY(-50%);pointer-events:none;padding-right: 15px;}
        .input-icon-start .form-control{padding-left:2.25rem}
    ...
    <div class="header">
        <div class="header-left active">
            <a href="index.php" class="logo logo-normal">
                <img src="https://bluebellenglishacademy.com/wp-content/uploads/2025/05/1.png" alt="Logo">
            </a>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right border shadow-sm dropdown-md">
                                ...
                                <div class="p-3 pb-0">
                                    <div class="row gx-2">
                                        <div class="col-6">
                                            <a href="ogrenci-ekle.php" class="d-block bg-primary-transparent ronded p-2 text-center mb-3 class-hover">
                                        ...
                                        <div class="col-6">
                                            <a href="kasa1.php" class="d-block bg-info-transparent ronded p-2 text-center mb-3 class-hover">
                                                <div class="avatar avatar-lg mb-2">
                                        ...
                                        <a href="activities.html">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <p class="mb-1"><span class="text-dark fw-semibold">Gösterilen</span> performans
                                                        eşiğin altında.</p>
                                                    <span>Şuanda</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="border-bottom mb-3 pb-3">
                                        <a href="activities.html" class="pb-0">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <p class="mb-1"><span class="text-dark fw-semibold">Sylvia</span> eklenen randevu
                                                        14:00'te</p>
                                    ...
                                    <div class="border-bottom mb-3 pb-3">
                                        <a href="activities.html">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <p class="mb-1">Yeni öğrenci kaydı <span class="text-dark fw-semibold"> George</span> oluşturuldu
                                    ...
                                    <div class="border-0 mb-3 pb-0">
                                        <a href="activities.html">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <p class="mb-1">Yeni öğretmen kaydı için <span class="text-dark fw-semibold">Elisa</span>
                                                    </p>
                                                    <span>09:45'te</span>
                                                </div>
                                            </div>
                    ...
                    <div class="dropdown ms-1">
                        <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
								<span class="avatar avatar-md rounded"> 
                                    <img src="https://ui-avatars.com/api/?name=<?= $user['ad'] ?>"   alt="img" class="img-fluid">
								</span>
                        </a>
                            ...
                            <div class="d-block">
                                <div class="d-flex align-items-center p-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-primary mb-0"><?= $rol = ($user['kisi_yetki'] == 1) ? 'Admin' : 'Personel'; ?></p>
                                    </div>
                                </div>
                                <hr class="m-0">

                                <hr class="m-0">
                                <a class="dropdown-item d-inline-flex align-items-center p-2" href="cikis.php"><i class="ti ti-login me-2"></i>Çıkış</a>
                            </div>
                        </div>
                    </div>
                </div>
